...
CREATE TABLE orders_2(
    ...
    FOREIGN KEY (custid) REFERENCES customer_2(custid),   -- 외래키
    FOREIGN KEY (bookid) REFERENCES book_2(bookid)   -- 외래키
);

-- 주문 데이터 추가
INSERT INTO orders_2(orderid, custid, bookid, saleprice, orderdate)
